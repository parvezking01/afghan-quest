    ...
    <div class="relative z-10 w-full max-w-md">
        <div class="glass-white rounded-3xl p-8 shadow-2xl" data-aos="fade-up">
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-black gradient-text mt-4">{{ app()->getLocale() === 'en' ? 'Login to Account' : 'ورود به حساب' }}</h2>
                <p class="text-gray-500 mt-2">{{ app()->getLocale() === 'en' ? 'Welcome to Afghan Quest' : 'به افغان کویست خوش آمدید' }}</p>
            </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="email" id="login_email"
                               ...
                               required autocomplete="off" placeholder="{{ app()->getLocale() === 'en' ? 'your@email.com' : 'your@email.com' }}">
                    </div>
                </div>
