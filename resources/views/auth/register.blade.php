            ...
            <div class="glass-white rounded-3xl p-8 shadow-2xl" data-aos="fade-up">
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-3xl font-black gradient-text mt-4">
                        {{ app()->getLocale() === 'en' ? 'Create Account' : 'ثبت نام' }}</h2>
                    <p class="text-gray-500 mt-2">
                        {{ app()->getLocale() === 'en' ? 'Join the Afghan Quest family' : 'به خانواده افغان کویست بپیوندید' }}
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" autocomplete="off">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label
                                class="block text-gray-700 font-medium mb-2">{{ app()->getLocale() === 'en' ? 'Full Name' : 'نام کامل' }}</label>
                            <input type="text" name="name" value="{{ old('name') }}"
                                ...
                                placeholder="{{ app()->getLocale() === 'en' ? 'Ahmad Mohammadi' : 'احمد محمدی' }}">
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label
                                class="block text-gray-700 font-medium mb-2">{{ app()->getLocale() === 'en' ? 'Phone Number' : 'شماره تماس' }}</label>
                        ...
                        <div class="mb-4">
                            <label
                                class="block text-gray-700 font-medium mb-2">{{ app()->getLocale() === 'en' ? 'WhatsApp Number' : 'شماره واتساپ' }}</label>
                    ...
                    <div class="mb-4">
                        <label
                            class="block text-gray-700 font-medium mb-2">{{ app()->getLocale() === 'en' ? 'Account Type' : 'نوع حساب' }}</label>
                        <select name="role"
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-primary-500 transition-all"
                            required>
                            <option value="tourist">{{ app()->getLocale() === 'en' ? '🧳 Tourist' : '🧳 گردشگر' }}</option>
                            <option value="hotel_owner">
                                {{ app()->getLocale() === 'en' ? '🏨 Hotel Owner' : '🏨 مالک هتل' }}</option>
                        </select>
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="password" name="password" id="password"
                                    ...
                                    placeholder="{{ app()->getLocale() === 'en' ? 'Min 8 characters' : 'حداقل ۸ کاراکتر' }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-primary-500 transition-all"
                                    required autocomplete="new-password"
                                    placeholder="{{ app()->getLocale() === 'en' ? 'Repeat password' : 'تکرار رمز عبور' }}">
                    ...
                    <button type="submit"
                        class="w-full gradient-gold text-primary-900 py-3 rounded-xl font-bold text-lg hover:shadow-xl transition-all mt-4">
