        ...
        <form action="{{ route('hotel_owner.hotels.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select name="province_id" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone') }}" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-left" dir="ltr" placeholder="+93 700 000 000" required>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">شماره واتساپ *</label>
                    <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-left" dir="ltr" placeholder="+93 700 000 000" required>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">ایمیل <span class="text-gray-400 text-xs">(اختیاری)</span></label>
                    <input type="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="info@hotel.com">
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">ساعت ورود *</label>
                    <input type="time" name="check_in_time" value="14:00" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">ساعت خروج *</label>
                    <input type="time" name="check_out_time" value="12:00" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                </div>
            </div>
