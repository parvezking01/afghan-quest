            ...
            <form action="{{ route('hotel_owner.hotels.update', $hotel) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="time" name="check_in_time" value="{{ old('check_in_time', $hotel->check_in_time) }}"
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            required>
                    </div>
                    <div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('hotel_owner.hotels.index') }}"
                        class="bg-gray-100 text-gray-600 px-8 py-3 rounded-xl font-bold hover:bg-gray-200 transition-colors">انصراف</a>
                </div>
            </form>
        </div>
    </div>
