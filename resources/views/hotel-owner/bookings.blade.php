                ...
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-700/50">
                        ...
                        <th class="text-right py-4 px-6 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase">نوع
                            اتاق</th>
                        <th class="text-right py-4 px-6 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase">تاریخ
                        </th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                    @forelse($bookings as $booking)
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50">
                            <td class="py-4 px-6 text-sm font-mono text-gray-700 dark:text-gray-200">
                                {{ $booking->booking_number }}</td>
                            <td class="py-4 px-6">
                                <p class="font-medium text-gray-700 dark:text-gray-200">{{ $booking->user->name ?? '-' }}
                                </p>
                            ...
                            <td class="py-4 px-6 text-sm text-gray-600 dark:text-gray-300">
                                {{ $booking->check_in_date?->format('Y-m-d') }} تا
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-12 text-gray-400 dark:text-gray-500">هیچ رزروی وجود
                                ندارد</td>
                        </tr>
                    @endforelse
                </tbody>
