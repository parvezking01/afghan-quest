...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm" data-aos="fade-up" data-aos-delay="300">
        <div class="flex items-center justify-between mb-4">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm" data-aos="fade-up" data-aos-delay="400">
        <div class="flex items-center justify-between mb-4">
...
<div class="grid md:grid-cols-2 gap-6 mb-8">
    ...
    <a href="{{ route('hotel_owner.bookings') }}" class="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-lg transition-all text-center group">
        <i class="fas fa-calendar-check text-4xl text-green-500 dark:text-green-400 mb-3 group-hover:scale-110 transition-transform"></i>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50">
                    <td class="py-4 px-6 text-sm font-medium text-gray-700 dark:text-gray-200">{{ $booking->user->name ?? '-' }}</td>
                    <td class="py-4 px-6 text-sm text-gray-600 dark:text-gray-300">{{ $booking->hotel->name ?? '-' }}</td>
                    <td class="py-4 px-6 text-sm text-gray-600 dark:text-gray-300">{{ $booking->whatsapp_number }}</td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center py-12 text-gray-400 dark:text-gray-500">هیچ رزروی وجود ندارد</td>
                </tr>
                @endforelse
            </tbody>
        </table>
