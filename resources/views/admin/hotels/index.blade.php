        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <th class="text-right py-4 px-6 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase">تایید</th>
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td class="py-4 px-6">
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500">{{ Str::limit($hotel->address, 40) }}</p>
                    </td>
                    <td class="py-4 px-6">
                    ...
                    <td class="py-4 px-6 text-sm text-gray-600 dark:text-gray-300">{{ $hotel->owner->name ?? '-' }}</td>
                    ...
                    <td class="py-4 px-6">
                        ...
                        <form id="approve-{{ $hotel->id }}" action="{{ route('admin.hotels.approve', $hotel) }}" method="POST" class="hidden">
                            @csrf
                            @method('PATCH')
                        </form>
                    </td>
