            ...
            <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="مثال: بند امیر" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="name_en" value="{{ old('name_en') }}"
                            ...
                            dir="ltr" placeholder="Band-e-Amir">
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">بهترین فصل
                            بازدید</label>
                        <input type="text" name="best_season" value="{{ old('best_season') }}"
                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="مثال: بهار و تابستان">
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">مدت زمان بازدید</label>
                        <input type="text" name="estimated_visit_duration" value="{{ old('estimated_visit_duration') }}"
                            class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="مثال: ۲-۳ ساعت">
                    </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea name="highlights" rows="3"
                        class="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="ویژگی‌های خاص این مکان...">{{ old('highlights') }}</textarea>
                </div>
