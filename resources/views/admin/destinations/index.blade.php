...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <p class="text-gray-500 dark:text-gray-400">کل: <span
                class="font-bold text-gray-700 dark:text-white">{{ $destinations->total() }}</span> مکان</p>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 dark:bg-gray-700/50">
                        ...
                        <th class="text-right py-4 px-6 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase">سختی
                        </th>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                    @forelse($destinations as $destination)
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                            <td class="py-4 px-6 text-sm text-gray-500 dark:text-gray-400">{{ $destination->display_order }}
                            </td>
                            <td class="py-4 px-6">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-12">
                                ...
                                <h3 class="text-lg font-bold text-gray-600 dark:text-gray-300 mb-2">هیچ مکانی وجود ندارد
                                </h3>
                                <a href="{{ route('admin.destinations.create') }}"
