    ...
    <div class="grid lg:grid-cols-2 gap-6">
        ...
        <div
            ...
            <div class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    {{ $provinces->where('is_trending', true)->count() }} مورد پرطرفدار</p>
            </div>
            <div class="p-4 max-h-96 overflow-y-auto">
                <div class="space-y-2">
                    @foreach ($provinces as $province)
                        <div
                            class="flex items-center justify-between p-3 rounded-xl {{ $province->is_trending ? 'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800' : 'bg-gray-50 dark:bg-gray-700/30' }}">
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div
                                        class="w-10 h-10 bg-gray-200 dark:bg-gray-600 rounded-lg flex items-center justify-center text-gray-400 dark:text-gray-500">
                                        <i class="fas fa-map-marked-alt"></i>
                                    </div>
                                @endif
                                <span
                                    class="font-medium text-gray-700 dark:text-gray-200 text-sm">{{ $province->name }}</span>
                            </div>
        ...
        <div
            ...
            <div class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    {{ $destinations->where('is_trending', true)->count() }} مورد پرطرفدار</p>
            </div>
            <div class="p-4 max-h-96 overflow-y-auto">
                <div class="space-y-2">
                    @foreach ($destinations as $destination)
                        <div
                            class="flex items-center justify-between p-3 rounded-xl {{ $destination->is_trending ? 'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800' : 'bg-gray-50 dark:bg-gray-700/30' }}">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <span
                                        class="font-medium text-gray-700 dark:text-gray-200 text-sm">{{ $destination->name }}</span>
                                    <p class="text-xs text-gray-400 dark:text-gray-500">{{ $destination->province->name }}
                                    </p>
                                </div>
                            </div>
                            <form action="{{ route('admin.trending.toggle') }}" method="POST">
        ...
        <div
            ...
            <div class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">{{ $hotels->where('is_trending', true)->count() }}
                    مورد پرطرفدار</p>
            </div>
            <div class="p-4 max-h-96 overflow-y-auto">
                <div class="space-y-2">
                    @foreach ($hotels as $hotel)
                        <div
                            class="flex items-center justify-between p-3 rounded-xl {{ $hotel->is_trending ? 'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800' : 'bg-gray-50 dark:bg-gray-700/30' }}">
                            <div class="flex items-center gap-3">
                                @if ($hotel->featured_image)
                                    <img src="{{ asset('storage/' . $hotel->featured_image) }}"
                                        class="w-10 h-10 rounded-lg object-cover">
                                @else
                                    <div
                                        class="w-10 h-10 bg-gray-200 dark:bg-gray-600 rounded-lg flex items-center justify-center text-gray-400 dark:text-gray-500">
                                ...
                                <div>
                                    <span
                                        class="font-medium text-gray-700 dark:text-gray-200 text-sm">{{ $hotel->name }}</span>
        ...
        <div
            ...
            <div class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
                ...
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">
                    {{ $packages->where('is_trending', true)->count() }} مورد پرطرفدار</p>
            </div>
            <div class="p-4 max-h-96 overflow-y-auto">
                <div class="space-y-2">
                    @foreach ($packages as $package)
                        <div
                            class="flex items-center justify-between p-3 rounded-xl {{ $package->is_trending ? 'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800' : 'bg-gray-50 dark:bg-gray-700/30' }}">
                            <div class="flex items-center gap-3">
                                ...
                                @endif
                                <span
                                    class="font-medium text-gray-700 dark:text-gray-200 text-sm">{{ $package->name }}</span>
                            </div>
                            <form action="{{ route('admin.trending.toggle') }}" method="POST">
                                @csrf
