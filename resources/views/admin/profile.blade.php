            ...
            <form action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-1">ایمیل قابل تغییر نیست</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="whatsapp" value="{{ old('whatsapp', auth()->user()->whatsapp) }}"
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 text-left"
                            dir="ltr" required>
                    </div>
                </div>
