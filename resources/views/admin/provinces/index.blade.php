    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <p class="text-gray-500 dark:text-gray-400">کل: <span
                    class="font-bold text-gray-700 dark:text-white">{{ $provinces->total() }}</span> ولایت</p>
        </div>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                    @forelse($provinces as $province)
                        <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                            <td class="py-4 px-6 text-sm text-gray-500 dark:text-gray-400">{{ $province->display_order }}
                            </td>
                            <td class="py-4 px-6">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-xl flex items-center justify-center text-lg">
                                        🏛️
                                    </div>
                                    <div>
                                        <p class="font-bold text-gray-700 dark:text-white">{{ $province->name }}</p>
                                        <p class="text-xs text-gray-400 dark:text-gray-500">
                                            {{ Str::limit($province->description, 50) }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-4 px-6 text-sm text-gray-500 dark:text-gray-400">{{ $province->name_en ?? '-' }}
                            </td>
                            <td class="py-4 px-6">
                                <span
                            ...
                            <td class="py-4 px-6">
                                <span
                                    class="bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 px-3 py-1 rounded-lg text-xs font-bold">
