...
@section('content')
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-left">
                    ...
                    <!-- Stats -->
                    <div
                        class="flex gap-6 mt-12 bg-white/10 backdrop-blur-md rounded-2xl p-6 inline-flex border border-white/20">
                        <div class="text-center">
                            <div class="text-4xl font-black text-gold-400 counter" data-target="{{ $provincesCount }}">0
                            </div>
                            <div class="text-gray-300 text-sm mt-1">
                                {{ app()->getLocale() === 'en' ? 'Provinces' : 'ولایت' }}</div>
                        </div>
                        <div class="w-px bg-white/20"></div>
                        <div class="text-center">
                            <div class="text-4xl font-black text-gold-400 counter" data-target="{{ $destinationsCount }}">0
                            </div>
                            <div class="text-gray-300 text-sm mt-1">
                                {{ app()->getLocale() === 'en' ? 'Destinations' : 'مکان' }}</div>
                        </div>
                        <div class="w-px bg-white/20"></div>
                        <div class="text-center">
                            <div class="text-4xl font-black text-gold-400 counter" data-target="{{ $hotelsCount }}">0
                            </div>
                            <div class="text-gray-300 text-sm mt-1">{{ app()->getLocale() === 'en' ? 'Hotels' : 'هوتل' }}
                            </div>
                        </div>
                        <div class="w-px bg-white/20"></div>
                        <div class="text-center">
                            <div class="text-4xl font-black text-gold-400 counter" data-target="{{ $packagesCount }}">0
                            </div>
                            <div class="text-gray-300 text-sm mt-1">
                                {{ app()->getLocale() === 'en' ? 'Tour Packages' : 'پکیج سیاحتی' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden lg:block" data-aos="fade-right" data-aos-delay="200">
                    <div class="relative">
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-gold-500/30 to-primary-500/30 rounded-3xl blur-2xl">
                        </div>
                        <div class="relative grid grid-cols-2 gap-3">
                            <img src="{{ asset('images/BANDI_AMIR.jpg') }}" alt="Band-e-Amir"
                                class="rounded-2xl shadow-2xl animate-float w-full h-48 object-cover">
                            <img src="{{ asset('images/ghor.jpg') }}" alt="Minaret of Jam"
                                class="rounded-2xl shadow-2xl animate-float-delay w-full h-48 object-cover mt-8">
                            <img src="{{ asset('images/mazar.jpg') }}" alt="Blue Mosque"
                                class="rounded-2xl shadow-2xl animate-float w-full h-48 object-cover">
                            <img src="{{ asset('images/noristan.jpg') }}" alt="Nuristan"
                                class="rounded-2xl shadow-2xl animate-float-delay w-full h-48 object-cover mt-8">
                        </div>
                    </div>
                </div>
    ...
    <section class="py-20 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16" data-aos="fade-up">
                <span
                    class="text-primary-500 font-bold text-sm bg-primary-50 dark:bg-primary-900/30 px-4 py-2 rounded-full inline-block mb-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($trendingProvinces as $province)
                    <div class="group card-3d bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl"
                        ...
                        <div class="relative overflow-hidden">
                            ...
                            <div
                                class="absolute top-4 left-4 gradient-btn text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
                                {{ Str::limit(locale_field($province, 'description'), 120) }}</p>
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('provinces.show', $province->slug) }}"
                                    class="inline-flex items-center gap-2 text-primary-500 font-bold group/link">
                                    {{ app()->getLocale() === 'en' ? 'View' : 'مشاهده' }}
                                    <i
                                        class="fas fa-arrow-left text-sm group-hover/link:-translate-x-1 transition-transform"></i>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('provinces.index') }}"
                    class="inline-flex items-center gap-2 text-primary-500 font-bold text-lg hover:gap-3 transition-all border-2 border-primary-500 px-8 py-3 rounded-full hover:bg-primary-500 hover:text-white">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach ($trendingDestinations as $destination)
                    <div class="group relative rounded-2xl overflow-hidden shadow-lg card-3d" data-aos="fade-up"
    ...
    <section class="py-20 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16" data-aos="fade-up">
                <span
                    class="text-gold-500 font-bold text-sm bg-gold-50 dark:bg-gold-900/20 px-4 py-2 rounded-full inline-block mb-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($trendingPackages as $package)
                    <div class="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg card-3d"
                        data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                        <div class="relative">
                            ...
                            <div
                                class="absolute top-4 right-4 gradient-gold text-primary-900 px-4 py-2 rounded-full font-black text-lg shadow-lg">
                            ...
                            <div class="flex items-center gap-4 text-gray-500 dark:text-gray-400 mb-3 text-sm">
                                ...
                                @if ($package->includes_guide)
                                    <span class="flex items-center gap-1"><i class="fas fa-user-tie text-primary-500"></i>
                                        {{ app()->getLocale() === 'en' ? 'Guide' : 'راهنما' }}</span>
                                @endif
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-6">
                                {{ Str::limit(locale_field($package, 'description'), 100) }}</p>
    ...
    <section class="py-20 bg-gray-50 dark:bg-gray-800">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg card-3d" data-aos="fade-up"
                    data-aos-delay="100">
                    <div
                    ...
                    <h5 class="font-bold text-lg mb-2">
                        {{ app()->getLocale() === 'en' ? 'Local Guides' : 'راهنمایان محلی' }}</h5>
                ...
                <div class="text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg card-3d" data-aos="fade-up"
                    data-aos-delay="200">
                    <div
                        class="w-16 h-16 bg-gold-100 dark:bg-gold-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-shield-alt text-2xl text-gold-500"></i>
                    </div>
                    <h5 class="font-bold text-lg mb-2">
                        {{ app()->getLocale() === 'en' ? 'Complete Safety' : 'امنیت کامل' }}</h5>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                ...
                <div class="text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg card-3d" data-aos="fade-up"
                    ...
                    <h5 class="font-bold text-lg mb-2">
                        {{ app()->getLocale() === 'en' ? 'Affordable Prices' : 'قیمت مناسب' }}</h5>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                ...
                <div class="text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg card-3d" data-aos="fade-up"
                    ...
                    <h5 class="font-bold text-lg mb-2">
                        {{ app()->getLocale() === 'en' ? '24/7 Support' : 'پشتیبانی ۲۴/۷' }}</h5>
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
    ...
    <section class="py-20 relative overflow-hidden"
        ...
        <div class="container mx-auto px-4 relative z-10 text-center" data-aos="fade-up">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('packages.index') }}"
                    class="gradient-gold text-primary-900 px-10 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition-all transform hover:-translate-y-1">
                    <i class="fas fa-suitcase ms-2"></i>
                    {{ app()->getLocale() === 'en' ? 'Book a Tour' : 'رزرو پکیج ها' }}
                </a>
                <a href="https://wa.me/93700000000" target="_blank"
                    class="bg-green-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-green-600 transition-all transform hover:-translate-y-1">
